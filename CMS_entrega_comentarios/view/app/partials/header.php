...
<head>
    ...
    <title>Información sobre pingüinos</title>
...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="<?php echo $_SESSION['home'] ?>" class="brand-logo" title="Inicio">
            <img src="<?php echo $_SESSION['public'] ?>img/logo.png" alt="Logo Pinguinos">
        </a>
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li>
                <a href="<?php echo $_SESSION['home'] ?>datos" title="Datos">Datos</a>
            </li>
            <li>
                <a href="<?php echo $_SESSION['home'] ?>acerca-de" title="Acerca de">Acerca de</a>
            </li>
            <li>
                <a href="<?php echo $_SESSION['home'] ?>comentarios" title="Comentarios">Comentarios</a>
            </li>
            <li>
