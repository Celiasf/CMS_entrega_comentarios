<h3>
    <a href="<?php echo $_SESSION['home'] ?>admin" title="Inicio">Inicio</a> <span>| Datos</span>
</h3>
<div class="row">
    <!--Nuevo-->
        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/datos/crear" ?>" title="Añadir nuevo dato">
            ...
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/datos/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/datos/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    ...
                    <p>
                        ¿Está seguro de que quiere borrar el dato<strong><?php echo $row->titulo ?></strong>?<br>
                        Esta acción no se puede deshacer.
                    </p>
                    <a href="<?php echo $_SESSION['home']."admin/datos/borrar/".$row->id ?>" title="Borrar">
